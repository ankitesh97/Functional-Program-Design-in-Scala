  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var deltaSqrt = $uD($g.Math.sqrt(a$1));
        var denom = (2 * $uD(a$2.apply__O()));
        var array = [(((-$uD(b$2.apply__O())) + deltaSqrt) / denom), (((-$uD(b$2.apply__O())) - deltaSqrt) / denom)];
...
$c_Lcalculator_TweetLength$.prototype.init___ = (function() {
  ...
  this.ColorSignal$1 = new $c_Lcalculator_Var().init___F0(expr);
  return this
});
